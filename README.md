...
![Banner](https://github.com/hoofer-vizality/mention-utilities/blob/main/assets/banner.png?raw=true)
<p align="center">
  <a href="#"><img align="center" alt="GitHub repo size" src="https://img.shields.io/github/repo-size/hoofer-vizality/mention-utilities?color=F68080&style=for-the-badge&logo=github">
...
![Preview](https://github.com/hoofer-vizality/mention-utilities/blob/main/assets/example.gif?raw=true)


# Installation
For installation, go to **Plugins -> Open a CMD / Powershell / Terminal / Gitbash** in the folder, and enter the following:
```
git clone https://github.com/hoofer-vizality/mention-utilities
```


# Issues / Concerns
Have an issue? Please make a request using our issue format which can be found [here](https://github.com/hoofer-vizality/mention-utilities/issues/new?template=ISSUE_TEMPLATE.md), thanks!